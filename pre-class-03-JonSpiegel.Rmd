...
#I call the dataframe, get a list of distinct (i.e. unique) countries, and then get the number of rows within that ***********DID NOT FINISH THIS ONE, NEED TO DO FOR EACH CONTINENT STILL*************
```
...
#Same issue as above, need to figure out how to the call up the country after finding its GDP
      
```
3. According to the data available, what was the average life expectancy across each continent in the 1980s?
```{r}

#Same exact as number 1 as far issue goes, how to get it for each continent (could make a loop, feels like hacking it)
```
